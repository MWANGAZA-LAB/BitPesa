...
const buyGoodsSchema = z.object({
  ...
  tillNumber: z.string()
    .min(5, 'Till number must be at least 5 digits')
    .max(7, 'Till number must be at most 7 digits')
    ...
    <div className="container mx-auto px-4 py-8 max-w-2xl">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Pay with Bitcoin Lightning and buy goods from any merchant with a till number
        </p>
      </div>
      ...
      {transactionState.status === 'idle' && (
        <Card>
          <CardHeader>
            <CardTitle>Buy Goods</CardTitle>
            <CardDescription>
              Enter the till number and amount to purchase goods
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  />
                  {errors.tillNumber && (
                    <p className="text-red-500 text-sm mt-1">{errors.tillNumber.message}</p>
                  )}
                </div>
              </div>
              ...
              <div>
                <Label htmlFor="accountReference">Reference (Optional)</Label>
                <Input
                  id="accountReference"
          ...
          <CardContent className="space-y-6">
            ...
            <Alert>
              <AlertDescription>
                ...
                Please pay promptly to complete your purchase.
              </AlertDescription>
            </Alert>
      ...
      {transactionState.status === 'failed' && (
        <Card>
          <CardContent className="text-center py-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              {transactionState.error || 'An error occurred while processing your purchase.'}
            </p>
            <Button
              onClick={() => setTransactionState({ status: 'idle' })}
              className="mt-4"
